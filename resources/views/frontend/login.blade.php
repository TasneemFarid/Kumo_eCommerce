        ...
        <div class="row align-items-start justify-content-between">
            ...
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                ...
                @if (session('verify_error'))
                    <div class="alert alert-success">{{session('verify_error')}}</div>
                @endif
                <form class="border p-3 rounded" action="{{route('customer_login')}}" method="POST">	
                    @csrf			
                    ...
                    <div class="form-group">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="eltio_k2">
                                <a href="{{route('customer_pass_reset_req')}}">Lost Your Password?</a>
                            </div>	
                        </div>
                    </div>
                    ...
                    <div class="my-3 text-center">
                        <p>
                            ...
                            <a href="{{route('github_redirect')}}" class="btn btn-secondary">
                                Login With
                            ...
                            <a href="{{route('google_redirect')}}" class="btn btn-danger">
                                Login With
                ...
                <div class="mb-3">
                   ...
                   @if (session('email_verify'))
                    ...
                    @if (session('email_verify_success'))
                        <div class="alert alert-success">{{session('success')}}</div>
                    @endif
                <form class="border p-3 rounded"  action="{{route('customer_store')}}" method="POST">
                    @csrf
                    <div class="row">
