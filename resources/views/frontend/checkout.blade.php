                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="First Name" name="name" value="{{Auth::guard('customerlogin')->user()->name}}"/>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label class="text-dark">Email *</label>
                                    <input type="email" class="form-control" placeholder="Email" name="email" value="{{Auth::guard('customerlogin')->user()->email}}"/>
                                </div>
                            </div>
                ...
                <div class="col-12 col-lg-4 col-md-12">
                    ...
                    <div class="card mb-4 gray">
                        ...
                        <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                            ...
                            <span>Subtotal</span> <span class="ml-auto text-dark ft-medium">TK <span class="subtotal">{{ session('subtotal')}}</span></span>
                            </li>
                            <li class="list-group-item d-flex text-dark fs-sm ft-regular">
