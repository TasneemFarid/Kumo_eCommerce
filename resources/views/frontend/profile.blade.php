        ...
        <div class="row align-items-start justify-content-between">
            ...
            <div class="col-12 col-md-12 col-lg-8 col-xl-8">
                ...
                <div class="row align-items-center">
                    <form class="row m-0" action="{{route('profile_update')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @if (session('success'))
                            <div class="col-lg-12 alert alert-success">{{session('success')}}</div>
                        @endif
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                @if (session('pass_err'))
                                    <strong class="text-danger">{{session('pass_err')}}</strong>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="country" placeholder="Country" value="{{Auth::guard('customerlogin')->user()->country}}" />
                            </div>
                        </div>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                <label class="small text-dark ft-medium">Address</label>
                                <input type="text" class="form-control" name="address" placeholder="Address" value="{{Auth::guard('customerlogin')->user()->address}}"/>
                            </div>
                        </div>
