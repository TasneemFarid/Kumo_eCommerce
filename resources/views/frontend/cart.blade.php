                ...
                <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x mb-4">
                    ...
                    <li class="list-group-item">
                        <div class="row align-items-center">
                            <div class="col-3">
                                <!-- Image -->
                                <a href="product.html"><img src="{{asset('uploads/product/preview')}}/{{
                                    $cart->rel_to_product->preview}}" alt="..." class="img-fluid"></a>
                            </div>
                            <div class="col d-flex align-items-center justify-content-between">
                                <div class="cart_single_caption pl-2">
                                    ...
                                    <p class="mb-1 lh-1"><span class="text-dark">Size: {{
                                        $cart->rel_to_size->size_name}}</span></p>
                                    <p class="mb-3 lh-1"><span class="text-dark">Color: {{
                                        $cart->rel_to_color->color_name}}</span></p>
                    ...
                    <div class="col-12 col-md-7">
                        ...
                        <form class="mb-7 mb-md-0" action="{{route('cart')}}" method="GET">
                            ...
                            <div class="row form-row">
                                <div class="col">
                                    <input class="form-control" name="coupon" value="{{@$_GET['coupon']}}" type="text" placeholder="Enter coupon code*">
                                </div>
                                <div class="col-auto">
