                  ...
                  <tr>
                    <td>
                      <table width="220" border="0" cellpadding="0" cellspacing="0" align="left" class="col">
                        <tbody>
                          <tr>
                            <td align="left"> <img src="https://i.postimg.cc/L8NwbXNL/logo.png" width="80" alt="logo" border="0" /></td>
                          </tr>
                          <tr class="hiddenMobile">
                            <td height="40"></td>
                          </tr>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; ">
                                  {{App\Models\BillingDetails::where('order_id', $order_id)->first()->name}}<br> {{App\Models\BillingDetails::where('order_id', $order_id)->first()->address}}<br>
                                  T: {{App\Models\BillingDetails::where('order_id', $order_id)->first()->phone}}
                                </td>
                              </tr>
                            </tbody>
                          </table>
