				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('add_variation')}}">Product Variation</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                    ...
                    <li><a class="has-arrow ai-icon" href="{{route('get_in_touch_list')}}" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Inbox</span>
						</a>
                    </li>
                    <li><a class="has-arrow ai-icon" href="{{route('contact_info')}}" aria-expanded="false">
							<i class="flaticon-381-television"></i>
